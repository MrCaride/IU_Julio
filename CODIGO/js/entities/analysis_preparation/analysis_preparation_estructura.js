window.estructura_analysis_preparation = {
    ...
    columnas_visibles_tabla : ['id_analysis_preparation', 'name_analysis_preparation', 'bib_analysis_preparation', 'file_analysis_preparation'],
