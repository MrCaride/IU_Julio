...
window.characteristic_def_tests = Array(
    // Tests de ID Characteristic - ADD & EDIT
    ...
    Array('characteristic', 'id_characteristic', 6, 'Validar formato EDIT', 'EDIT', 'boolean', 'id_characteristic_format_KO'),    // Tests de Name Characteristic - ADD & EDIT
    ...
    Array('characteristic', 'name_characteristic', 12, 'Validar formato EDIT', 'EDIT', 'boolean', 'name_characteristic_format_KO'),    // Tests de Description - ADD & EDIT
    ...
    Array('characteristic', 'description_characteristic', 18, 'Validar formato EDIT', 'EDIT', 'boolean', 'description_characteristic_format_KO'),    // Tests de File Characteristic - ADD & EDIT
...
window.characteristic_tests = Array(
    ...
    // Tests de Name Characteristic - ADD
    ...
    // Tests de Name Characteristic - EDIT
...
window.characteristic_tests_files = Array(
    // Tests de tamaño de archivo - ADD
    ...
    // Tests de tamaño de archivo - EDIT
    ...
    // Tests de formato de nombre de archivo - ADD
    ...
    // Tests de formato de nombre de archivo - EDIT
